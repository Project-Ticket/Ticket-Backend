        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($users)
                ...
                ->addColumn('action', function ($row) {
                    return '
                        <div class="d-flex justify-content-center">
                            <button class="btn btn-warning open-global-modal me-1" data-url="' . route('user.edit', $row->uuid) . '" data-title="Edit User">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="btn btn-danger btn-global-delete" data-url="' . route('user.destroy', $row->uuid) . '">
                ...
                ->editColumn('name', function ($row) {
                    return '<a href="javascript:void(0)" class="open-global-modal" data-url="' . route('user.show', $row->uuid) . '">' . e($row->name) . '</a>';
                })
